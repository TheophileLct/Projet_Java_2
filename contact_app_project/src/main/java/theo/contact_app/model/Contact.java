...
public class Contact {
	...
	public Contact(int idperson, String lastname, String firstname, String nickname, String phone_number, Address address, String email_address, LocalDate birth_date) {
